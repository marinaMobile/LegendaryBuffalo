package com.zeptolab.bull.blck
...
import com.zeptolab.bull.blck.CNST.C1
import com.zeptolab.bull.blck.CNST.D1
import com.zeptolab.bull.blck.CNST.DEV
import com.zeptolab.bull.databinding.ActivityFilterBinding
import com.zeptolab.bull.wht.Games
        ...
        runBlocking {
            try {
                ...
                if (jsoup == CNST.jsoupCheck) {
                    Intent(applicationContext, Games::class.java).also { startActivity(it) }
                } else {
